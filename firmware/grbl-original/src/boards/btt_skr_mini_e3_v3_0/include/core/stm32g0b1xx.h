...
// Not needed for bare metal coding
...
typedef struct
{
  ...
  volatile uint32_t AWD1TR;  /*!< ADC analog watchdog 1 threshold register,      Address offset: 0x20 */
  volatile uint32_t AWD2TR;  /*!< ADC analog watchdog 2 threshold register,      Address offset: 0x24 */
  volatile uint32_t CHSELR;  /*!< ADC group regular sequencer register,          Address offset: 0x28 */
  volatile uint32_t AWD3TR;  /*!< ADC analog watchdog 3 threshold register,      Address offset: 0x2C */
  ...
  volatile uint32_t CALFACT; /*!< ADC Calibration factor register,               Address offset: 0xB4 */
} ADC_TypeDef;
...
typedef struct
{
  ...
  volatile uint32_t RXGFC;  /*!< FDCAN Global Filter Configuration register,                      Address offset: 0x080 */
  volatile uint32_t XIDAM;  /*!< FDCAN Extended ID AND Mask register,                             Address offset: 0x084 */
  volatile uint32_t HPMS;   /*!< FDCAN High Priority Message Status register,                     Address offset: 0x088 */
  uint32_t RESERVED5;       /*!< Reserved,                                                                        0x08C */
  volatile uint32_t RXF0S;  /*!< FDCAN Rx FIFO 0 Status register,                                 Address offset: 0x090 */
  volatile uint32_t RXF0A;  /*!< FDCAN Rx FIFO 0 Acknowledge register,                            Address offset: 0x094 */
  volatile uint32_t RXF1S;  /*!< FDCAN Rx FIFO 1 Status register,                                 Address offset: 0x098 */
  volatile uint32_t RXF1A;  /*!< FDCAN Rx FIFO 1 Acknowledge register,                            Address offset: 0x09C */
  ...
  volatile uint32_t TXBRP;  /*!< FDCAN Tx Buffer Request Pending register,                        Address offset: 0x0C8 */
  volatile uint32_t TXBAR;  /*!< FDCAN Tx Buffer Add Request register,                            Address offset: 0x0CC */
  volatile uint32_t TXBCR;  /*!< FDCAN Tx Buffer Cancellation Request register,                   Address offset: 0x0D0 */
  volatile uint32_t TXBTO;  /*!< FDCAN Tx Buffer Transmission Occurred register,                  Address offset: 0x0D4 */
  volatile uint32_t TXBCF;  /*!< FDCAN Tx Buffer Cancellation Finished register,                  Address offset: 0x0D8 */
  volatile uint32_t TXBTIE; /*!< FDCAN Tx Buffer Transmission Interrupt Enable register,          Address offset: 0x0DC */
  volatile uint32_t TXBCIE; /*!< FDCAN Tx Buffer Cancellation Finished Interrupt Enable register, Address offset: 0x0E0 */
  volatile uint32_t TXEFS;  /*!< FDCAN Tx Event FIFO Status register,                             Address offset: 0x0E4 */
  volatile uint32_t TXEFA;  /*!< FDCAN Tx Event FIFO Acknowledge register,                        Address offset: 0x0E8 */
} FDCAN_GlobalTypeDef;
...
typedef struct
{
  volatile uint32_t CKDIV; /*!< FDCAN clock divider register,                            Address offset: 0x100 + 0x000 */
...
typedef struct
{
  volatile uint32_t CSR_ODD;  /*!< COMP control and status register located in register of comparator instance odd (exception for STM32G0 devices featuring ADC3 instance: in common group of COMP2 and COMP3, instances odd and even are inverted), used for bits common to several COMP instances, Address offset: 0x00 */
  volatile uint32_t CSR_EVEN; /*!< COMP control and status register located in register of comparator instance even (exception for STM32G0 devices featuring ADC3 instance: in common group of COMP2 and COMP3, instances odd and even are inverted), used for bits common to several COMP instances, Address offset: 0x04 */
} COMP_Common_TypeDef;
...
typedef struct
{
  ...
  volatile uint32_t CR;     /*!< Debug configuration register,    Address offset: 0x04 */
  volatile uint32_t APBFZ1; /*!< Debug APB freeze register 1,     Address offset: 0x08 */
  volatile uint32_t APBFZ2; /*!< Debug APB freeze register 2,     Address offset: 0x0C */
} DBG_TypeDef;
...
typedef struct
{
  volatile uint32_t CCR; /*!< DMA Multiplexer Channel x Control Register    Address offset: 0x0004 * (channel x) */
} DMAMUX_Channel_TypeDef;

typedef struct
{
  volatile uint32_t CSR; /*!< DMA Channel Status Register                    Address offset: 0x0080   */
  volatile uint32_t CFR; /*!< DMA Channel Clear Flag Register                Address offset: 0x0084   */
} DMAMUX_ChannelStatus_TypeDef;

typedef struct
{
  volatile uint32_t RGCR; /*!< DMA Request Generator x Control Register     Address offset: 0x0100 + 0x0004 * (Req Gen x) */
} DMAMUX_RequestGen_TypeDef;

typedef struct
{
  volatile uint32_t RGSR;  /*!< DMA Request Generator Status Register        Address offset: 0x0140   */
  volatile uint32_t RGCFR; /*!< DMA Request Generator Clear Flag Register    Address offset: 0x0144   */
...
typedef struct
{
  ...
  volatile uint32_t RESERVED1; /*!< Reserved1,                                          Address offset: 0x20 */
  volatile uint32_t CFGR2;     /*!< LPTIM Option register,                              Address offset: 0x24 */
} LPTIM_TypeDef;
...
typedef struct
{
  ...
  volatile uint32_t OR;       /*!< RTC option register,                                       Address offset: 0x60 */
} RTC_TypeDef;
...
typedef struct
{
  ...
  volatile uint32_t FLTCR; /*!< Reserved                                                   Address offset: 0x0C */
...
typedef struct
{
  volatile uint32_t CHEP0R;       /*!< USB Channel/Endpoint 0 register,      Address offset: 0x00 */
  volatile uint32_t CHEP1R;       /*!< USB Channel/Endpoint 1 register,      Address offset: 0x04 */
  volatile uint32_t CHEP2R;       /*!< USB Channel/Endpoint 2 register,      Address offset: 0x08 */
  volatile uint32_t CHEP3R;       /*!< USB Channel/Endpoint 3 register,      Address offset: 0x0C */
  volatile uint32_t CHEP4R;       /*!< USB Channel/Endpoint 4 register,      Address offset: 0x10 */
  volatile uint32_t CHEP5R;       /*!< USB Channel/Endpoint 5 register,      Address offset: 0x14 */
  volatile uint32_t CHEP6R;       /*!< USB Channel/Endpoint 6 register,      Address offset: 0x18 */
  volatile uint32_t CHEP7R;       /*!< USB Channel/Endpoint 7 register,      Address offset: 0x1C */
  volatile uint32_t RESERVED0[8]; /*!< Reserved,                                                  */
  volatile uint32_t CNTR;         /*!< Control register,                     Address offset: 0x40 */
  volatile uint32_t ISTR;         /*!< Interrupt status register,            Address offset: 0x44 */
  volatile uint32_t FNR;          /*!< Frame number register,                Address offset: 0x48 */
  volatile uint32_t DADDR;        /*!< Device address register,              Address offset: 0x4C */
  volatile uint32_t RESERVED1;    /*!< Reserved */
  volatile uint32_t LPMCSR;       /*!< LPM Control and Status register,      Address offset: 0x54 */
  volatile uint32_t BCDR;         /*!< Battery Charging detector register,   Address offset: 0x58 */
} USB_DRD_TypeDef;
...
typedef struct
{
  volatile uint32_t TXBD; /*!<Transmission buffer address*/
  volatile uint32_t RXBD; /*!<Reception buffer address */
